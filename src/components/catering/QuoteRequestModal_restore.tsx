                ...
                {!submitted ? (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <h4 className="text-lg font-semibold text-verde-dark">Tu información</h4>
                      
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <label htmlFor="name" className="block text-sm font-medium text-verde-dark mb-1">
                            Nombre completo *
                          </label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label htmlFor="email" className="block text-sm font-medium text-verde-dark mb-1">
                            Correo electrónico *
                          </label>
                          <input
                            type="email"
                        ...
                        <div>
                          <label htmlFor="phone" className="block text-sm font-medium text-verde-dark mb-1">
                            Teléfono *
                          </label>
                          <input
                            type="tel"
                    ...
                    <div className="space-y-4">
                      <h4 className="text-lg font-semibold text-verde-dark">Información del evento</h4>
                      
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <label htmlFor="eventType" className="block text-sm font-medium text-verde-dark mb-1">
                            Tipo de evento *
                          </label>
                          <select
                            id="eventType"
                            ...
                            className="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-verde-medium focus:border-transparent outline-none transition"
                          >
                            <option value="" style={{ color: '#33503E' }}>Selecciona una opción</option>
                            {eventTypes.map((type) => (
                              <option key={type} value={type} style={{ color: '#33503E' }}>
                                {type}
                              </option>
                            ))}
                          </select>
                        ...
                        <div>
                          <label htmlFor="guestCount" className="block text-sm font-medium text-verde-dark mb-1">
                            Número de invitados *
                          </label>
                          <input
                            type="number"
                        ...
                        <div>
                          <label htmlFor="eventDate" className="block text-sm font-medium text-verde-dark mb-1">
                            Fecha del evento
                          </label>
                          <input
                            type="date"
                        ...
                        <div>
                          <label htmlFor="eventLocation" className="block text-sm font-medium text-verde-dark mb-1">
                            Lugar del evento
                          </label>
                          <input
                            type="text"
                            ...
                            className="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-verde-medium focus:border-transparent outline-none transition placeholder:text-verde-dark"
                          />
                        </div>
                      </div>
                      
                      <div>
                        <label htmlFor="message" className="block text-sm font-medium text-verde-dark mb-1">
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-2 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-verde-medium focus:border-transparent outline-none transition resize-none placeholder:text-verde-dark"
                        />
                      </div>
                    </div>
                    ...
                    <div className="pt-4 border-t border-neutral-200">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
                        <div className="flex items-center gap-2" style={{ color: '#33503E', fontWeight: '500' }}>
                  ...
                  <div className="py-8 text-center">
                    ...
                    <h4 className="text-2xl font-bold text-verde-dark mb-2">¡Gracias por contactarnos!</h4>
