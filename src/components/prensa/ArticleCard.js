  ...
  return (
    <article className="bg-white rounded-lg card-shadow overflow-hidden group hover:scale-[1.02] transition-all duration-300">
      ...
      <div className="p-6">
        ...
        {/* Título */}
        <h3 className="text-lg font-bold text-principal mb-3 group-hover:text-gray-600 transition-colors line-clamp-2">
          {article.title}
        </h3>
        ...
        <div className="mb-4 relative group">
          {article.publicationLogo ? (
            <a 
              ...
              className="block w-full h-16 md:h-20 overflow-hidden bg-white flex items-center justify-start border border-gray-200 rounded-sm p-2 relative"
            >
              <Image 
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full h-16 md:h-20 bg-gray-200 flex items-center justify-center relative"
            >
              <span className="text-gray-600 text-2xl font-bold z-10 group-hover:scale-95 transition-transform duration-300">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <Share2 className="h-4 w-4 text-terracota" />
            </button>
          </div>
        </div>
      </div>
    ...
    <article className="bg-gradient-to-br from-gray-700 to-gray-900 text-black rounded-lg card-shadow overflow-hidden group hover:scale-[1.02] transition-all duration-300">
      ...
      <div className="relative h-56 overflow-hidden">
        ...
        <div className="absolute top-4 left-4">
          <div className="badge badge-destacado bg-white text-gray-700 flex items-center gap-1">
      ...
      {/* Contenido del artículo */}
      <div className="p-6">
        <h3 className="text-xl font-bold mb-4 group-hover:underline text-white">
          {article.title}
        </h3>
        ...
        <div className="mb-4 relative group">
          {article.publicationLogo ? (
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block relative w-full h-20 overflow-hidden bg-white rounded-sm"
            >
              <Image 
                src={article.publicationLogo} 
                alt={article.publication}
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full h-20 bg-white flex items-center justify-center relative"
            >
              <span className="text-gray-600 text-2xl font-bold z-10 group-hover:scale-95 transition-transform duration-300">
                {article.publication.charAt(0)}
              </span>
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex items-center justify-between border-t border-white border-opacity-20 pt-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1 text-terracota font-medium hover:underline"
            >
              Leer artículo <ExternalLink className="h-4 w-4" />
            </a>
