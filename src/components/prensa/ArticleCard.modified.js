      ...
      <div className="p-6">
        ...
        <div className="mb-4 relative group">
          {article.publicationLogo ? (
            ...
            <div className="w-full h-16 md:h-20 bg-gray-200 flex items-center justify-center relative">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex items-center justify-between">
            <a
              ...
              className="inline-flex items-center gap-1 text-gray-700 text-sm font-medium hover:underline"
            >
