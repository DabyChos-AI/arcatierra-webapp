...
export default function XochimilcoPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative bg-[#33503E] text-white py-12 sm:py-16 md:py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="mb-12 md:mb-16">
          <div className="bg-[#33503E] text-white rounded-lg p-6 sm:p-8">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="bg-[#E3DBCB] rounded-lg p-6 sm:p-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:p-8 items-center">
              <div>
